...
- **Application 1:** [`code/1 - quantPlate_shiny_2.R`](<code/1 - quantPlate_shiny_2.R>)
- **Application 2:** [`code/2 - dna_amount_shiny7.R`](<code/2 - dna_amount_shiny7.R>)  
- **Application 3:** [`code/3 - Normalize_DNA_for_PCR.R`](<code/3 - Normalize_DNA_for_PCR.R>)
